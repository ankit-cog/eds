...
const section = document.querySelector('.forms-video-container');

if (section) {

  const video = section.querySelector('.video-wrapper');
  const columns = section.querySelector('.columns-wrapper');

  if (video && columns) {

    const wrapper = document.createElement('div');
    wrapper.className = 'video-columns-inner';
